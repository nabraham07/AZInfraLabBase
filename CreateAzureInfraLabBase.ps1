...
# $assetLocation = "https://rawgit.com/nabraham07/AZInfraLabBase/master/"  Wanted to use this, but sometimes it fails.

$assetLocation = "https://raw.githubusercontent.com/nabraham07/AZInfraLabBase/master/"
